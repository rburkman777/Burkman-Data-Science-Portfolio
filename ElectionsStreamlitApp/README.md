...
If the first method does not work, you can create files and folders in vscode named exactly after each of the files and folders here and copy and paste the code from each respective file into the files/folders you created (the name of the larger folder should be the same as here ("ElectionsStreamlitApp) and the urbanization-index-2022.csv file needs to be in the "data" folder).
