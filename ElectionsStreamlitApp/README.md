...
If the first method does not work, you can create a new folder in vscode named "ElectionsStreamlitApp." Then, create a folder inside of that new folder called "data." Download the urbanization-index-2022.csv file into vscode and place it into the "data" folder. Then add the "Elections_Streamlit_App_Code.py" file into the "ElectionsStreamlitApp" folder but outside of the "data" folder. 
