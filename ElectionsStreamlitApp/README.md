...
Alternatively, can also download the Elections_Streamlit_App_Code.py and urbanization-index-2022 files and open them in the same repository in vscode. Then place the urbanization-index-2022.csv file in a folder you create called "data." 
